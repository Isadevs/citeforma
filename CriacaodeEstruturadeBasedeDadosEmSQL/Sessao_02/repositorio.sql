...
ALTER TABLE River DROP PRIMARY KEY;
DROP TABLE River_log;

SHOW TABLES;

INSERT INTO River(Name, Location, CountryID, CategoryID)
VALUES("TejoSSSS", "44°35 65°45 W", 4, 3);

DROP TRIGGER AfterInsertRiver;

SELECT * FROM River_log;

UPDATE River
SET Name = "MICHEL TELO"
WHERE id = 6355;

SHOW CREATE TABLE River;

DESC River;

SELECT * FROM River ORDER BY Name LIMIT 10;
